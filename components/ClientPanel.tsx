          ...
          {companies.map(c => (
            ...
            >
              <div className="h-40 relative overflow-hidden">
                ...
                <div className="absolute top-3 right-3 z-20 bg-white/20 backdrop-blur-sm p-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <div className="p-5">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-primary-700 uppercase tracking-wide text-[10px] mb-0.5">Benefício</p>
